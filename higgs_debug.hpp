...
#ifndef higgs_debug_hpp
	#define higgs_debug_hpp
	...
	void debug(void* pointer, int location, higgs_String name, higgs_String method, higgs_String type){
		// Serial.println("Name");
		// Serial.println(name);
		...
		// Serial.println("Type");
		// Serial.println(type);
		if(location == higgs_Log_StartSetup){
		...
		if(location == higgs_Log_Statement){
			//    System::console.print("Loggin class: ");
			//    System::console.print(name);
			//    System::console.print(" - Method: ");
			//    System::console.println(method);
