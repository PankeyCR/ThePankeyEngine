...
#ifndef InterruptState_hpp
#define InterruptState_hpp
#define InterruptState_AVAILABLE
...
#ifdef InterruptState_LogApp
	#include "ame_Logger_config.hpp"
	#include "ame_Logger.hpp"
	
	#define InterruptStateLog(location,method,type,mns) ame_Log(this,location,"InterruptState",method,type,mns)
	#define const_InterruptStateLog(location,method,type,mns) 
	#define StaticInterruptStateLog(pointer,location,method,type,mns) ame_Log(pointer,location,"InterruptState",method,type,mns)
#else
	#ifdef InterruptState_LogDebugApp
		#include "ame_Logger_config.hpp"
		#include "ame_Logger.hpp"
		
		#define InterruptStateLog(location,method,type,mns) ame_LogDebug(this,location,"InterruptState",method,type)
		#define const_InterruptStateLog(location,method,type,mns) 
		#define StaticInterruptStateLog(pointer,location,method,type,mns) ame_LogDebug(pointer,location,"InterruptState",method,type)
	#else
		#define InterruptStateLog(location,method,type,mns) 
		#define const_InterruptStateLog(location,method,type,mns) 
		#define StaticInterruptStateLog(pointer,location,method,type,mns) 
	#endif
#endif
...
class InterruptState IMPLEMENTATION_BaseAppState {
    public:
		InterruptState(){}
		virtual ~InterruptState(){}
			
		#if defined(cppObject_AVAILABLE) && defined(cppObjectClass_AVAILABLE) && defined(Class_AVAILABLE)
		virtual cppObjectClass* getClass(){
			return Class<InterruptState>::classType;
		}
		
		virtual bool instanceof(cppObjectClass* cls){
			return cls == Class<InterruptState>::getClass()
