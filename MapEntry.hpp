	...
	#include "MemberMapEntry.hpp"
		...
		#define MapEntryLog(location,method,type,mns) higgs_Log((void*)this,location,"MapEntry",method,type,mns)
	#else
	...
	namespace higgs{
		...
		class MapEntry : public MemberMapEntry<H,M>{
			public:
				...
				MapEntry(){
					MapEntryLog(higgs_Log_StartMethod, "Constructor", "println", "");
					MapEntryLog(higgs_Log_EndMethod, "Constructor", "println", "");
				}
				...
				virtual ~MapEntry(){
					MapEntryLog(higgs_Log_StartMethod, "Destructor", "println", "");
					MapEntryLog(higgs_Log_EndMethod, "Destructor", "println", "");
				}
				
				virtual Pointer<K,H,M> getKey()const{
					MapEntryLog(higgs_Log_StartMethod, "getKey", "println", "");
					MapEntryLog(higgs_Log_EndMethod, "getKey", "println", "");
					return this->m_key;
				}
				virtual Pointer<V,H,M> getValue()const{
					MapEntryLog(higgs_Log_StartMethod, "getValue", "println", "");
					MapEntryLog(higgs_Log_EndMethod, "getValue", "println", "");
					return this->m_value;
				}
                ...
                virtual void setHolder(HOLDER_TYPE a_holder){
                    MemoryHolderLog(higgs_Log_StartMethod, "setHolder", "println","Shouldnt be used");
                    MemoryHolderLog(higgs_Log_Error, "setHolder", "println","This method shouldnt be used");
                ...
                virtual HOLDER_TYPE getHolder()const{
                    MemoryHolderLog(higgs_Log_StartMethod, "getHolder", "println","");
                    MemoryHolderLog(higgs_Log_Error, "getHolder", "println","This method shouldnt be used");
                    MemoryHolderLog(higgs_Log_EndMethod, "getHolder", "println","");
                    return nullptr;
                }
				...
				virtual POINTER_TYPE getRawPointer()const{
					...
					POINTER_TYPE i_pointer = MemoryHolderManager<H>::get(this->getManager(), m_holder);
					MemoryHolderLog(higgs_Log_Statement, "getRawPointer", "println","POINTER_TYPE is null?");
				...
				virtual MapEntry& operator=(const MapEntry<K,V,H,M>& a_map_entry){
					MapEntryLog(higgs_Log_StartMethod, "operator=", "println", "");
					m_key = a_map_entry.m_key;
					m_value = a_map_entry.m_value;
					MapEntryLog(higgs_Log_EndMethod, "operator=", "println", "");
					return *this;
				}
				...
				virtual bool isNull()const{
					MapEntryLog(higgs_Log_StartMethod, "isNull", "println", "");
					MapEntryLog(higgs_Log_EndMethod, "isNull", "println", "");
