...
#if defined(DISABLE_JsonImporter)
	#define JsonImporter_hpp
#endif

#ifndef JsonImporter_hpp
#define JsonImporter_hpp
#define JsonImporter_AVAILABLE
...
#ifdef JsonImporter_LogApp
	#include "ame_Logger_config.hpp"
	#include "ame_Logger.hpp"
	
	#define JsonImporterLog(location,method,type,mns) ame_Log(this,location,"JsonImporter",method,type,mns)
#else
	#ifdef JsonImporter_LogDebugApp
		#include "ame_Logger_config.hpp"
		#include "ame_Logger.hpp"
		
		#define JsonImporterLog(location,method,type,mns) ame_LogDebug(this,location,"JsonImporter",method,type)
	#else
		#define JsonImporterLog(location,method,type,mns) 
	#endif
#endif

namespace ame{

class JsonImporter : public MonkeyImporter{
    public:
		JsonImporter(){}
