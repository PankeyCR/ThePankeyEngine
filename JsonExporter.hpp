...
#if defined(DISABLE_JsonExporter)
	#define JsonExporter_hpp
#endif

#ifndef JsonExporter_hpp
#define JsonExporter_hpp
#define JsonExporter_AVAILABLE
...
#ifdef JsonExporter_LogApp
	#include "ame_Logger_config.hpp"
	#include "ame_Logger.hpp"
	
	#define JsonExporterLog(location,method,type,mns) ame_Log(this,location,"JsonExporter",method,type,mns)
#else
	#ifdef JsonExporter_LogDebugApp
		#include "ame_Logger_config.hpp"
		#include "ame_Logger.hpp"
		
		#define JsonExporterLog(location,method,type,mns) ame_LogDebug(this,location,"JsonExporter",method,type)
	#else
		#define JsonExporterLog(location,method,type,mns) 
	#endif
#endif

namespace ame{

class JsonExporter : public MonkeyExporter{
    public:
		JsonExporter(){}
