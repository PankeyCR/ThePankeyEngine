...
#ifndef higgs_Print_hpp
#define higgs_Print_hpp
...
class Print{
  ...
  public:
    ...
    virtual size_t print(const higgs_Byte& a_value){ return 0; }
    virtual size_t print(const bool& a_value){ return 0; }
    virtual size_t print(const float& a_value){ return 0; }
    virtual size_t print(const higgs_String &){ return 0; }
    ...
    virtual size_t println(const higgs_String &s){ return 0; }
