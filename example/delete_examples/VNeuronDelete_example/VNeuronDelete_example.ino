...
void setup() {
  ...
  entity = new VNeuron<5>("parent");
  entity->attach(new VNeuron<2>("arm_left"));
  entity->attach(new VNeuron<2>("arm_right"));
  entity->attach(new VNeuron<2>("leg_left"));
  entity->attach(new VNeuron<2>("leg_right"));
