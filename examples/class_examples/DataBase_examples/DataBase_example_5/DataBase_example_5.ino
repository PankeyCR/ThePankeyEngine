...
void MessageEvent(Message* message){
  ...
  String idN = importer.read("DataBase.id", "");
  ...
  if(command == "getAll"){
    ...
    exporter.write("DataBase.type", "objet");
    exporter.write("DataBase.objects", true);

    Serial.println("Sending getAll");
    serialState->send("DataBase",exporter.getText());
    return;
  }
  ...
  if(command == "get"){
    ...
    exporter.write("DataBase.command", "get");
    exporter.write("DataBase.type", "objet");
    exporter.write("DataBase.id", ElementId(idN));
...
//!DataBase.command#put$DataBase.id#pikachu$DataBase.parent#pokemon$DataBase.parent.int#23$DataBase.parent.float#54.34$DataBase.parent.string#hola$!
