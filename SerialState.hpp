...
class SerialState : public SerialNetwork{
    public:
		...
		virtual void initializeSerialServers(SerialState* a_serialState){
			SerialStateLog(ame_Log_StartMethod, "initializeSerialServers", "println", "");
			...
			SerialStateLog(ame_Log_EndMethod, "initializeSerialServers", "println", "");
		}

		virtual SerialServer* getSerialServer(int index){
			SerialStateLog(ame_Log_StartMethod, "getSerialServer", "println", "int index");
			SerialStateLog(ame_Log_EndMethod, "getSerialServer", "println", "");
		...
		virtual SerialServer* getSerialServer(cppObjectClass* cls){
			SerialStateLog(ame_Log_StartMethod, "getSerialServer", "println", "cppObjectClass* cls");
			for(int x = 0; x < m_servers.getPosition(); x++){
				SerialServer* i_server = m_servers.getKeyByPosition(x);
				if(i_server == nullptr){
					continue;
		...
		virtual MapEntry<SerialPort,PortProtocol> addSerialPort(SerialPort* a_port, PortProtocol* a_protocol){
			SerialStateLog(ame_Log_StartMethod, "addSerialPort",  "println", "SerialPort* a_port, PortProtocol* a_protocol");
		...
		virtual void initializeSerialPorts(SerialState* a_serialState){
			SerialStateLog(ame_Log_StartMethod, "initializeSerialPorts", "println", "");
			...
			SerialStateLog(ame_Log_EndMethod, "initializeSerialPorts", "println", "");
		}
